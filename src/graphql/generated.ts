...
export type GetSubscriberByIdQuery = { __typename?: 'Query', subscriber?: { __typename?: 'Subscriber', name: string } | null };
...
export const GetSubscriberByIdDocument = gql`
    query GetSubscriberById($id: ID) {
  subscriber(where: {id: $id}, stage: DRAFT) {
    name
  }
}
    `;
 ...
 * });
 */
export function useGetSubscriberByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetSubscriberByIdQuery, GetSubscriberByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSubscriberByIdQuery, GetSubscriberByIdQueryVariables>(GetSubscriberByIdDocument, options);
      }
export function useGetSubscriberByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSubscriberByIdQuery, GetSubscriberByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSubscriberByIdQuery, GetSubscriberByIdQueryVariables>(GetSubscriberByIdDocument, options);
        }
